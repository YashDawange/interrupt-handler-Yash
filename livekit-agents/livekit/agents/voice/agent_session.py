...
class AgentSessionOptions:
    ...
    semantic_interruption_soft_words: Sequence[str] | None
    semantic_interruption_stop_commands: Sequence[str] | None
    semantic_interruption_correction_cues: Sequence[str] | None
...
class AgentSession(rtc.EventEmitter[EventTypes], Generic[Userdata_T]):
    def __init__(
        ...
        *,
        ...
        semantic_interruption_soft_words: Sequence[str] | None = None,
        semantic_interruption_stop_commands: Sequence[str] | None = None,
        semantic_interruption_correction_cues: Sequence[str] | None = None,
        ...
        self._opts = AgentSessionOptions(
            ...
            semantic_interruption_soft_words=semantic_interruption_soft_words,
            semantic_interruption_stop_commands=semantic_interruption_stop_commands,
            semantic_interruption_correction_cues=semantic_interruption_correction_cues,

...
class AgentSession(rtc.EventEmitter[EventTypes], Generic[Userdata_T]):
    def __init__(
        ...
        *,
        ...
        filler_words: frozenset[str] | set[str] | None = None,
        ...
        Args:
            ...
            ivr_detection (bool): Whether to detect if the agent is interacting with an IVR system.
                Default ``False``.
            filler_words (frozenset[str] | set[str] | None): Custom set of filler words to
                ignore during interruption detection. When set, these words are treated as
                passive backchanneling and won't interrupt agent speech. When ``None``,
                uses the default filler words from the interruption_filter module.
                Default ``None``.
        ...
        self._opts = AgentSessionOptions(
            ...
            filler_words=frozenset(filler_words) if filler_words else None,
        )

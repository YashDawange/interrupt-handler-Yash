...
class AgentSession(rtc.EventEmitter[EventTypes], Generic[Userdata_T]):
    def __init__(
        ...
        *,
        ...
        ignore_words: Sequence[str] = ("yeah", "ok", "hmm", "right", "uh-huh", "uh huh"),
        ...
        Args:
            ...
            ivr_detection (bool): Whether to detect if the agent is interacting with an IVR system.
                Default ``False``.
            ignore_words (Sequence[str]): List of words that should be ignored as interruptions
                when the agent is speaking. Default ``("yeah", "ok", "hmm", "right", "uh-huh", "uh huh")``.

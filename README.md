...
<*Respond*> normally when silent.

 See `_interrupt_by_audio_activity` in [`livekit-agents/livekit/agents/voice/agent_activity.py`](livekit-agents/livekit/agents/voice/agent_activity.py).

...
# Add parent directory to path for interrupt_handler import
sys.path.insert(0, str(Path(__file__).parent.parent))
from interrupt_handler import Decision, InterruptionController
    ...
    def _on_user_input_transcribed(ev: UserInputTranscribedEvent):
        ...
        if not ev.is_final:
            ...
            if not has_interrupt:
                ...
                logger.debug(f"⏭️ SKIP (interim, likely filler): '{transcript}'")
                return
